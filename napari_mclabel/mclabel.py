...
class McLabel(QWidget):
    ...
    def __init__(self, napari_viewer):
        ...
        self.viewer.window.add_dock_widget(
            [self.manual_mode_cb, self.start_button, self.preproc_button, self.timer_start_stop,
             self.layer_selection_lbl, self.layer_selection_cb, self.algo_selection_lbl,self.algo_selection_cb,self.threshold_slider_lbl, self.threshold_slider],
            area='right',
            name='McLabel')
    ...
    def draw_fn(self):
        ...
        labels = np.zeros(self.image_layer.data.shape[self.viewer.dims.ndim - self.viewer.dims.ndisplay:], dtype='int32') # label helper is always 2D
    ...
    def _load_model(self):
        ...
        self.sam_anything_predictor = SamAutomaticMaskGenerator(model=self.sam_model, pred_iou_thresh=0.75, stability_score_thresh=0.75)
